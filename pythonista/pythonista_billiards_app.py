...
class MainController(ui.ViewController):
    ...
    def load_view(self):
        ...
        self.power_field.placeholder = 'أدخل قوة التسديقة'
...
الإحصائيات الكاملة
━━━━━━━━━━━━━━━
إجمالي التسديقات: {stats['total_shots']}
